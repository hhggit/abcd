...
template <typename... Ts>
using filter_interface = mp_unique<mp_apply<mp_append,
    mp_transform<extend_helper::to_qlist,
        mp_filter<is_interface, mp_transform_if<has_pub_interface, to_interface,
                                    mp_list<Ts...>>>>>>;

template <typename T, typename... Ts>
using make_interface = typename extend_helper::extend<
    access<T>>::template with_ql<filter_interface<Ts...>>;
} // namespace detail
